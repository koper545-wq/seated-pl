...
import { ArrowLeft, HelpCircle, Calendar, ChefHat, CreditCard, Search } from "lucide-react";
...
const categories = [
  {
    ...
    label: "Ogólne",
    icon: HelpCircle,
    description: "Podstawowe informacje o Seated",
  },
  {
    id: "booking",
    label: "Rezerwacje",
    icon: Calendar,
    description: "Jak rezerwować i anulować",
  },
  {
    id: "hosts",
    label: "Dla Hostów",
    icon: ChefHat,
    description: "Informacje dla organizatorów",
  },
  {
    id: "payments",
    label: "Płatności",
    icon: CreditCard,
    description: "Jak działają płatności i zwroty",
  },
] as const;
      ...
      <div className="bg-gradient-to-b from-amber-50 to-stone-50 py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-lg text-stone-600">
            Znajdź odpowiedzi na najczęstsze pytania o Seated. Nie znalazłeś
            odpowiedzi?{" "}
            <a
        ...
        <Card className="bg-stone-900 text-white">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-stone-300 mb-6 max-w-md mx-auto">
              Nasz zespół pomocy jest gotowy odpowiedzieć na wszystkie Twoje
              pytania.
            </p>
