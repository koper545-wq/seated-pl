      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-neutral max-w-none">
          ...
          <div className="bg-white border border-border rounded-xl p-6 mb-10">
            <h2 className="text-lg font-bold text-foreground mb-4 mt-0">
              Spis treści
            </h2>
            <nav className="grid grid-cols-1 md:grid-cols-2 gap-1 text-sm">
              {[
                ...
                <a
                  key={item.n}
                  href={item.href}
                  className="text-muted-foreground hover:text-primary no-underline py-1 flex items-center gap-2"
                >
                  <span className="text-primary font-mono text-xs w-5">
                    {item.n}.
                  </span>
                  {item.label}
                </a>
          ...
          <section className="mb-10" id="role-uzytkownikow">
            ...
            <p className="text-muted-foreground mb-3">Dwa podtypy:</p>
            ...
            <details className="mb-6">
              <summary className="text-muted-foreground font-medium cursor-pointer hover:text-primary">
                Dane zbierane od hosta (rozwiń)
              </summary>
              <ul className="list-disc pl-6 text-muted-foreground space-y-1 mt-2 text-sm">
          ...
          <section className="mb-10" id="model-biznesowy">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-5 mb-6">
              ...
              <div className="grid grid-cols-3 gap-4 text-center text-sm">
                <div>
                  <div className="font-bold text-foreground">200 PLN</div>
                  <div className="text-muted-foreground">Gość płaci</div>
                </div>
                <div>
                  <div className="font-bold text-green-700">30 PLN</div>
                  <div className="text-muted-foreground">Seated (15%)</div>
                </div>
                <div>
                  <div className="font-bold text-foreground">170 PLN</div>
                  <div className="text-muted-foreground">Host (85%)</div>
                </div>
              </div>
            </div>
          ...
          <section className="mb-10" id="proces-rezerwacji">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
              <div className="bg-white border border-border rounded-lg p-4">
                <div className="font-bold text-foreground mb-1">Instant</div>
                <p className="text-muted-foreground text-sm m-0">
                  Automatyczne zatwierdzenie, natychmiastowa rezerwacja
                </p>
              </div>
              <div className="bg-white border border-border rounded-lg p-4">
                <div className="font-bold text-foreground mb-1">Manual</div>
                <p className="text-muted-foreground text-sm m-0">
            ...
            <div className="bg-muted rounded-lg p-4 mb-6 font-mono text-sm text-muted-foreground">
          ...
          <section className="mb-10" id="dokumentacja">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-white border border-border rounded-lg p-4">
                <h3 className="text-lg font-bold text-foreground mt-0 mb-2">
                  Regulamin
                </h3>
          ...
          <section className="mb-10" id="problemy-prawne">
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-xl p-5 mb-6">
              <h3 className="text-lg font-bold text-primary mt-0 mb-4 flex items-center gap-2">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="text-left py-2 pr-4 text-muted-foreground font-medium w-24">
                      Priorytet
                    </th>
                ...
                <tbody className="text-muted-foreground">
                  {[
                    ...
                    <tr key={row.n} className="border-b border-border/50">
                      <td className="py-2 pr-2 text-muted-foreground/70">{row.n}</td>
          ...
          <section className="mb-10" id="pytania">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={i}
                  className="flex gap-3 bg-white border border-border rounded-lg p-4"
                >
                  ...
                  <p className="text-muted-foreground text-sm m-0">{q}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="border-t border-border pt-8">
            <div className="bg-muted rounded-xl p-6 text-center">
              <h3 className="text-lg font-bold text-foreground mt-0 mb-3">
                Kontakt
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm text-muted-foreground">
                <div>
                  <div className="font-medium text-foreground">Platforma</div>
                  Seated.pl
                </div>
                <div>
                ...
                <div>
                  <div className="font-medium text-foreground">Prywatność</div>
                  <a
