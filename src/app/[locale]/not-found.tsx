...
export default function NotFound() {
  return (
    <div className="relative overflow-hidden flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      <AnimatedBlob variant={1} className="absolute -top-20 -right-20 w-72 h-72 z-0" opacity={0.10} duration={22} rotate={[-3, 3]} />
      <AnimatedBlob variant={2} className="absolute -bottom-16 -left-16 w-64 h-64 z-0" opacity={0.08} duration={26} rotate={[-2, 2]} />
      <AnimatedBlob variant={6} className="absolute top-1/3 left-1/4 w-48 h-48 z-0" opacity={0.08} duration={30} rotate={[-4, 4]} />
